...
```{r ggplot2, echo = F,  eval = TRUE,  message = FALSE, warning=FALSE, fig.width = 8, fig.height= 4}
...
```{r ggplot1, echo = F,  eval = TRUE,  message = FALSE, warning=FALSE, fig.width = 8, fig.height= 4}
...
```{r ggplot5, echo = F,  eval = TRUE,  message = FALSE, warning=FALSE, fig.width = 7}
...
```{r ggplot6, echo = F,  eval = TRUE,  message = FALSE, warning=FALSE, fig.width = 7}
g2      
```
