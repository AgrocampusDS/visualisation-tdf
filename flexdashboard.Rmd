...
p <- p + scale_size_continuous(limits=c(1*3, max(Count_Etape_lim$n)), breaks=seq(3, max(Count_Etape_lim$n), by=4), range = c(0,2)) + guides(size=guide_legend(ncol=2))  + labs(colour="Time period") + labs(size = "Nb of stages between cities")
p
```
