...
p + scale_size_continuous(limits=c(1, max(Count_Etape_lim$n)), breaks=seq(1, max(Count_Etape_lim$n), by=3), range = c(0,2)) + guides(size=guide_legend(ncol=2)) + labs(title= "Carte de l'évolution des étapes") + labs(colour="Période") + labs(size = "Nb de fois villes connectées")
...
>>>>>>> d624a691fab4198305b129f27db501f788fd9207
